...
<body>
    <div class="contener">
        <img src="__PUBLIC__/Admin/Images/welcome.png" style="display:block; width:600px; height:206px; margin:100px auto;"/>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="all_cont">
            ...
            <tr>
                <td width="50%">服务器域名/IP地址：<?php echo $_SERVER['SERVER_NAME']?>(<?php echo @gethostbyname($_SERVER['SERVER_NAME'])?>)</td>
                <td width="50%">服务器时间：<?php echo date("Y年n月j日 H:i:s")?></td>
            </tr>

            <tr>
                <td>服务器操作系统：<?php $os = explode(" ", php_uname()); echo $os[0];?>&nbsp;(内核版本：<?php echo $os[2]?>)</td>
